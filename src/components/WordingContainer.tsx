    ...
    <div id="wordingContainer" className="wording-container p-4 sm:p-6 space-y-4">
      ...
      <div id="listwrap" data-testid="wording-container" data-layout={layoutMode} className={`listwrap ${layoutMode}`}>
        {results.length === 0 ? (
          <div
            id="empty"
            className="p-12 text-center border border-dashed border-stone-800 rounded-xl bg-stone-900 text-stone-400 text-sm flex flex-col items-center justify-center gap-3 min-h-[220px]"
          >
          ...
          <div
            className={
              layoutMode === 'grid'
                ...
                : layoutMode === 'table'
                ? 'wording-table-body flex flex-col divide-y divide-stone-800 border border-stone-800 rounded-xl bg-stone-900 overflow-hidden shadow-xs'
