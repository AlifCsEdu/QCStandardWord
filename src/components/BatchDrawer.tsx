  ...
  return (
    <>
      ...
      <div
        ...
        } fixed top-0 right-0 w-[420px] max-w-[92vw] h-full bg-stone-900 border-l border-stone-800 z-[999] flex flex-col p-4 sm:p-5 gap-4 box-border overflow-hidden shadow-2xl transition-transform duration-300 ease-out`}
      >
        {/* Top Header Controls Bar */}
        <div className="flex justify-between items-center border-b border-stone-800 pb-3.5 shrink-0">
          <div className="flex items-center gap-2.5">
            <div className="p-1.5 rounded-lg bg-stone-800/80 border border-stone-700/60 text-stone-300">
          ...
          <Button
            ...
            className="text-stone-400 hover:text-stone-100 hover:bg-stone-800 h-8 w-8 rounded-lg transition-colors cursor-pointer"
          >
        ...
        <div className="p-3 rounded-xl border border-stone-800 bg-stone-950/80 flex flex-col gap-3 shadow-inner shrink-0">
              ...
              {DELIMITER_OPTIONS.map((opt) => {
                ...
                return (
                  <button
                    ...
                    className={`py-1.5 px-0.5 rounded-md text-xs font-mono text-center flex flex-col items-center justify-center transition-all duration-150 active:scale-95 cursor-pointer select-none ${
                      isActive
          ...
          {/* Auto-clear Toggle */}
          <div className="flex justify-between items-center gap-2 pt-1 border-t border-stone-800/80">
            <label
              htmlFor="autoclear"
            ...
            <input
              ...
              className="size-4 rounded border-stone-700 bg-stone-900 accent-stone-300 cursor-pointer focus:ring-stone-500/30 transition-colors"
            />
          </div>
        </div>
        ...
        <div
          id="blist"
          className="flex-1 overflow-y-auto flex flex-col gap-2 min-h-[160px] pr-0.5"
        >
          {batchQueue.length === 0 ? (
            <div className="p-8 text-center border border-dashed border-stone-800 rounded-xl text-stone-500 text-xs flex flex-col items-center justify-center gap-2 my-auto">
              <div className="p-2.5 rounded-full bg-stone-800/50 border border-stone-800 text-stone-400">
            ...
            batchQueue.map((itemText, idx) => (
              <div
                ...
                className="bitem group p-2.5 rounded-xl border border-stone-800 bg-stone-950 hover:border-stone-700 flex items-center justify-between gap-2 transition-all duration-150 shadow-xs"
              >
                <div className="flex items-center gap-2 flex-1 min-w-0">
                  ...
                  <span
                    className="bt flex-1 overflow-hidden text-ellipsis whitespace-nowrap text-xs font-medium text-stone-200 group-hover:text-stone-100"
                ...
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  <button
                    type="button"
                    className="bdn p-1.5 rounded-md border border-stone-700 text-xs font-bold transition-all duration-150 flex items-center justify-center disabled:opacity-30 disabled:cursor-not-allowed disabled:pointer-events-none active:scale-90 text-stone-300 bg-stone-800 hover:bg-stone-700 hover:border-stone-600 hover:text-stone-100 cursor-pointer"
                    data-mvdn={idx}
                    data-mdown={idx}
                    data-down={idx}
                    data-act="movedown"
                  ...
                  <button
                    type="button"
                    data-bc={idx}
                    className="bcopy-item border border-stone-700 bg-stone-800 hover:bg-stone-700 hover:text-stone-100 text-stone-300 px-2 py-1 rounded-md text-xs font-mono font-semibold transition-all duration-150 active:scale-95 cursor-pointer flex items-center gap-1"
                  ...
                  <button
                    ...
                    className="brm-item border border-rose-900/60 bg-rose-950/40 hover:bg-rose-900/60 text-rose-400 hover:text-rose-300 px-1.5 py-1 rounded-md text-xs font-semibold transition-all duration-150 active:scale-90 cursor-pointer flex items-center justify-center"
        ...
        <div className="flex flex-col gap-2.5 border-t border-stone-800 pt-3.5 shrink-0">
          ...
          <Button
            ...
            className="w-full bg-stone-100 hover:bg-white text-stone-900 font-bold text-sm gap-2 h-10 shadow-sm transition-all duration-150 rounded-lg flex items-center justify-center cursor-pointer active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed"
          >
          ...
          <div className="flex gap-2">
            <Button
              ...
              disabled={batchQueue.length === 0}
              className="flex-1 bg-rose-950/40 border border-rose-800/60 text-rose-400 hover:bg-rose-900/60 hover:text-rose-300 transition-all duration-150 active:scale-95 h-9 rounded-lg flex items-center justify-center gap-1.5 text-xs font-semibold cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
            >
            ...
            <Button
              ...
              className="flex-1 bg-stone-800 border border-stone-700 text-stone-200 hover:bg-stone-700 hover:text-stone-100 transition-all duration-150 active:scale-95 h-9 rounded-lg flex items-center justify-center gap-1.5 text-xs font-semibold cursor-pointer"
            >
        ...
        <DialogContent className="bg-stone-900 border border-stone-800 text-stone-100 max-w-md shadow-2xl">
          ...
          <div className="py-2">
            <Textarea
              ...
              rows={6}
              className="w-full bg-stone-950 border border-stone-800 text-stone-100 text-sm focus-visible:ring-stone-600 font-mono"
            />
          </div>
          ...
          <DialogFooter className="gap-2 sm:gap-0">
            <Button
              ...
              className="bg-stone-800 border-stone-700 text-stone-300 hover:bg-stone-700 cursor-pointer"
            >
              Cancel
            </Button>
            <Button
              onClick={handleBulkSubmit}
              className="bg-stone-100 text-stone-900 font-semibold hover:bg-white shadow-xs cursor-pointer"
            >
              Import Lines
            </Button>
          </DialogFooter>
